...
router.get('/',(req,res,next) => {
    ...
    res.render('shop',{Products : products, pageTitle: 'Shop/Home', path:'/'});  //? render method is an express method that uses default templating engine and then returns the specified template and also allows dynamic variables to be entered
